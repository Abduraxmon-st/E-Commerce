...
import qrcodee from '../../assets/img/qrcodee.png'
import { GooglePlayIcon } from '../../assets/icons/GooglePlayIcon'
import { AppleStoreIcon } from '../../assets/icons/AppleStoreIcon'
export const Footer = () => {
   return (
      <div className='bg-black mt-35 text-[#fafafa]'>
         <div className="container mx-auto pt-20 pb-15 flex justify-between">
            <form>
               <p className='font-[Inter] font-bold text-2xl leading-6 -tracking-tight'>Exclusive</p>
               <p className='mt-6 font-medium text-xl leading-7'>Subscribe</p>
               <p className='mt-6'>Get 10% off your first order</p>
               <div className='relative mt-4 flex items-center w-[216px] h-12'>
                  <input className='absolute w-full border-2 border-white rounded-sm py-3 pl-4 pr-10' placeholder='Enter your email' type="email" />
            ...
            <ul className='flex flex-col gap-4'>
               <p className='font-medium text-xl leading-7 mb-2'>Support</p>
               <li className='hover:underline'><a href="#">111 Bijoy sarani, Dhaka, <br />  DH 1515, Bangladesh.</a></li>
               <li className='hover:underline'><a href="#">exclusive@gmail.com</a></li>
               <li className='hover:underline'><a href="#">+88015-88888-9999</a></li>
            </ul>
            <ul className='flex flex-col gap-4'>
               <p className='font-medium text-xl leading-7 mb-2'>Account</p>
               <li className='hover:underline'><a href="#">My Account</a></li>
               <li className='hover:underline'><a href="#">Login / Register</a></li>
               <li className='hover:underline'><a href="#">Cart</a></li>
               <li className='hover:underline'><a href="#">Wishlist</a></li>
               <li className='hover:underline'><a href="#">Shop</a></li>
            </ul>
            <ul className='flex flex-col gap-4'>
               <p className='font-medium text-xl leading-7 mb-2'>Quick Link</p>
            ...
            <div>
               <p className='font-medium text-xl leading-7 mb-2'>Download App</p>
               <p className='font-medium text-xs leading-[18px] mt-6'>Save $3 with App New User Only</p>
               <div className='flex gap-2 mt-2.5'>
                  <img src={qrcodee} alt="" />
                  <div className='flex flex-col justify-between'>
                     <button><a href="#"><GooglePlayIcon /></a></button>
                     <button><a href="#"><AppleStoreIcon /></a></button>
                  </div>
               </div>
               <div className='flex items-center gap-6 mt-6'>
                  <a className='hover:border border border-black hover:border-white rounded-sm' href="#"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a className='hover:border border border-black hover:border-white rounded-sm' href="#">
                     <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_14932_1563)">
         ...
         <div className='flex items-center justify-center gap-1.5 opacity-40 py-4 mt-15 border-t border-t-[#939393]'>
            <svg width={21} height={20} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.5 18.3332C15.1024 18.3332 18.8334 14.6022 18.8334 9.99984C18.8334 5.39746 15.1024 1.6665 10.5 1.6665C5.89765 1.6665 2.16669 5.39746 2.16669 9.99984C2.16669 14.6022 5.89765 18.3332 10.5 18.3332Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M13 8.14799C13 8.14799 11.9706 6.6665 10.2549 6.6665C8.53924 6.6665 7.16669 8.14799 7.16669 9.99984C7.16669 11.8517 8.53924 13.3332 10.2549 13.3332C11.9706 13.3332 13 11.8517 13 11.8517" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
         </svg>
